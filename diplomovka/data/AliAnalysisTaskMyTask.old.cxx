...
AliAnalysisTaskMyTask::AliAnalysisTaskMyTask() : AliAnalysisTaskSE(), 
    ...
    fHistPocetK0(0), fHistLambdaMassPtCut(0), fHistK0MassPtCut(0),fHistAntiLambdaMassPtCut(0),fHistAntiLambdaHadron(0),fHistPocetAntiLambda(0),
	fHistKorelacie(0), fHistV0Multiplicity(0)
{
...
AliAnalysisTaskMyTask::AliAnalysisTaskMyTask(const char* name) : AliAnalysisTaskSE(name),
	...
	fHistLambdaMassPtCut(0), fHistK0MassPtCut(0), fHistLambdaPhi(0), fHistAntiLambdaMassPtCut(0),fHistAntiLambdaHadron(0), fHistPocetAntiLambda(0),
	fHistKorelacie(0), fHistV0Multiplicity(0)
{
    // constructor
...
void AliAnalysisTaskMyTask::UserCreateOutputObjects()
{
	...
	Int_t kMassBins = 50;
	Float_t kMassMinK = 0.44;
	Float_t kMassMaxK = 0.54;

	Float_t kMassMinLambda = 1.08;
	Float_t kMassMaxLambda = 1.16;
...
void AliAnalysisTaskMyTask::UserExec(Option_t *)
{
    ...
    for(Int_t i=0; i < iTracks; i++) {                 // loop ove rall these tracks
        ...
        for(Int_t j=0; j < iV0; j++) { 
			...
			Bool_t k0 = ((massK0>0.47)&&(massK0<0.53));
			Bool_t Lambda = ((massLambda>1.10)&&(massLambda<1.13));
			Bool_t Antilambda = ((massAntilambda>1.10)&&(massAntilambda<1.13));
