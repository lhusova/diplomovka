...
\begin{figure}[hbtp!]
	\begin{center}
		\includegraphics[scale=0.3]{./Obrazky_praca/QGP1.png}
...
\begin{figure}[hbtp!]
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/ALICEpPbPred.png}
		\caption{}
		\label{ALICEpPBPhiPred}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/ALICEpPbPo.png}
		\caption{}
		\label{ALICEpPBPhiPo}
	\end{subfigure}
...
\begin{figure}[hbtp!]
	\centering
	\includegraphics[scale=0.3]{../histogramy/massK0.png}
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.85\linewidth]{../histogramy/massLam.png}
		\caption{}
		\label{Lam}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.85\linewidth]{../histogramy/massALam.png}
		\caption{}
		\label{ALam}
	\end{subfigure}
...
\begin{figure}[hbtp!]
	\centering
	\includegraphics[scale=0.35]{../histogramy/vytazky/ucinnost.png}
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_Kh_prilahly_mult.png}
		\caption{}
		\label{K0pril}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_Kh_protilahly_mult.png}
		\caption{}
		\label{K0proti}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_Lh_prilahly_mult.png}
		\caption{}
		\label{Lampril}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_Lh_protilahly_mult.png}
		\caption{}
		\label{Lamproti}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_hh_prilahly_mult.png}
		\caption{}
		\label{hhpril}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{./Obrazky_praca/vytazky_hh_protilahly_mult.png}
		\caption{}
		\label{hhproti}
	\end{subfigure}
...
\begin{figure}[hbtp!]
	\centering
	\includegraphics[width=0.7\textwidth]{./Obrazky_praca/odcitane.png}
